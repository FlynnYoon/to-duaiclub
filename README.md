...
DUAI 점심 모임에서 작업을 마친 뒤 `/to-duaiclub` 한 번이면, AI가 결과물을 요약하고 스크린샷·데모 영상을 만들어 [www.duaiclub.com](https://www.duaiclub.com) 오늘 모임 일정에 올려줍니다. 목표 시간은 5분 이내입니다.
...
오늘 모임 일정(없으면 오늘 날짜의 일정)에 아래 형식의 댓글로 올라갑니다. 대시보드의 최근 댓글에도 표시됩니다.
요약 3~4줄은 AI가 대화 내용과 git 커밋을 보고 직접 씁니다. 회원이 입력할 것은 없고, 올리기 전 미리보기에서 고칠 수만 있습니다.

```
**[오늘의 작업] Claude Code로 식단 추천 봇 만들기**
